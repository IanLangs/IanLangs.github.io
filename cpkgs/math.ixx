...
export namespace math {
    ...
    // ------------------------------
    export inline long double arrow(long double a, long double b, int n) {
    ...
    export inline long double H(long double a, long double b, int n) {
        if(n==1) return a+b;
        if(n==2) return a*b;
    ...
    // ------------------------------
    export inline long double ackermann(long double m, long double n) {
    ...
    // ESTRUCTURAS SIMPLES
    // ------------------------------
    export struct tree_node { int value; std::vector<tree_node*> children; tree_node(int v): value(v) {} };
    export struct sscg_node { int id; std::vector<int> neighbors; sscg_node(int i): id(i) {} };
    export struct scg_node  { int id; std::vector<int> neighbors; scg_node(int i): id(i) {} };
